...
def calculate_density_section():
    ...
    st.header("Kalkulator Hubungan Kerapatan dan Kepekatan Larutan Garam🧪⚗️", divider="violet")
    st.write("""
...
def about_us_section():
    st.header("Kalkulator Hubungan Kerapatan dan Kepekatan Larutan Garam 🧪⚗️", divider="rainbow")
    st.write("""
